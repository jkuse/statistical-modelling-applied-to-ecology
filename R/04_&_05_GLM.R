...
# DICA:
# 1. Plote os residuos x variáveis explanatorias não incluidas no modelo: se ocorrer um padrao, inclua essa variavel;
# 2. Plote os residuos x variáveis explanatorias incluidas no modelo: se ocorrer um padrao, inclua um termo quadrático;
